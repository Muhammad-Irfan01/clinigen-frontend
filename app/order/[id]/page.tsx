...
import { ChevronLeft, ChevronDown, ChevronUp, Download, Package } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F9F9F9] p-6 md:p-10 font-sans text-[#1A1A1A]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
          <h1 className="text-3xl font-extrabold">Order {params.id || "10535700"}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-sm text-gray-600 font-medium">
                  Part Ground Floor, Drayton Court, Drayton Road, Solihull, B90 4NG, United Kingdom
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border-2 border-black p-6 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center pt-6">
              ...
              <span className="text-2xl font-black">£47.28</span>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <tr className="border-b last:border-0">
                  <td className="px-6 py-6">
                    <p className="font-bold text-sm text-[#1A1A1A]">zinc aspartate</p>
                  ...
                  <td className="px-6 py-6 text-sm font-bold text-gray-600">£19.70</td>
                  <td className="px-6 py-6 text-sm font-bold text-gray-600">2</td>
                  <td className="px-6 py-6 text-sm font-black">£39.40</td>
                  <td className="px-6 py-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-4">
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Brand</p><p className="text-sm font-bold text-gray-800">Unizink</p></div>
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Over-labelled</p><p className="text-sm font-bold text-gray-800">No</p></div>
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Manufacturer</p><p className="text-sm font-bold text-gray-800">Kohler</p></div>
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Product code</p><p className="text-sm font-bold text-gray-800">1001300</p></div>
                    </div>
                  </div>
                  {/* Col 2 */}
                  <div className="space-y-5">
                    <h4 className="text-xs font-bold text-[#1A1A1A] uppercase border-b pb-2">Licensing</h4>
                    <div className="space-y-4">
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Country of license</p><p className="text-sm font-bold text-gray-800">Germany</p></div>
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">License holder</p><p className="text-sm font-bold text-gray-800">Kohler</p></div>
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">License number</p><p className="text-sm font-bold text-gray-800">6073335.00.00</p></div>
                    </div>
                  </div>
                  {/* Col 3 */}
                  <div className="space-y-5">
                    <h4 className="text-xs font-bold text-[#1A1A1A] uppercase border-b pb-2">Handling and storage</h4>
                    <div className="space-y-4">
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Controlled drug status</p><p className="text-sm font-bold text-gray-800">Not Controlled</p></div>
                      <div>
                      ...
                      <div><p className="text-[10px] font-bold text-gray-400 uppercase">Cytotoxic</p><p className="text-sm font-bold text-gray-800">No</p></div>
                      <div>
