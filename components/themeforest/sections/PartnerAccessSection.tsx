    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-[#1D0E62] leading-tight">
          ...
          >
            ...
            <button
              ...
              className="bg-[#C4A7F0] hover:bg-[#B595E8] text-white font-medium px-6 py-1 rounded-full transition-colors"
            >
              See How It Works
            </button>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#A98DF2] to-[#C4A7F0] rounded-2xl px-6 py-5 md:px-8 md:py-6 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
