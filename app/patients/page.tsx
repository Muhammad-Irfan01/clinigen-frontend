...
export default function Patients() {
  ...
  const [activeFilter, setActiveFilter] = useState("My programs");
    ...
    <div className="min-h-screen bg-[#f9f8f4] font-sans selection:bg-purple-100">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <main className="flex flex-col items-center justify-center py-20">
          ...
          <h2 className="text-2xl font-bold text-[#2d1a47] mb-3">No patients yet</h2>
          <p className="text-gray-500 text-center max-w-md font-medium">
            It looks like you haven't created any patients yet.{" "}
            <button className="text-[#7c3aed] underline hover:text-[#6d28d9] transition-colors">
